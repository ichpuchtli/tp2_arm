...
RGBInit(unsigned long ulEnable)
{
    ...
    /* Reserve these timers to ensure they are not reused */
    (void) cTallocReserveTimer(RED_TIMER_BASE, TIMER_BOTH);
    (void) cTallocReserveTimer(GREEN_TIMER_BASE, TIMER_BOTH);
    (void) cTallocReserveTimer(BLUE_TIMER_BASE, TIMER_BOTH);

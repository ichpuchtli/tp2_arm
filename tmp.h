...
#define SRC_PERIPH    SYSCTL_PERIPH_GPIOB
#define SRC_PORT      GPIO_PORTB_BASE
#define SRC_PIN0      GPIO_PIN_3
#define SRC_PIN1      GPIO_PIN_2
#define SRC_PIN2      GPIO_PIN_0
#define SRC_PIN3      GPIO_PIN_1
...
static void vLEDMatrixPointPWM(uint8_t ucX, uint8_t ucY){
    ...
    switch( ucY ){
      ...
      case 0:
        GPIOPinWrite(SRC_PORT, SRC_PIN0 | SRC_PIN1 | SRC_PIN2 | SRC_PIN3, SRC_PIN0 );
        break;
      case 1:
        GPIOPinWrite(SRC_PORT, SRC_PIN0 | SRC_PIN1 | SRC_PIN2 | SRC_PIN3, SRC_PIN1 );
        break;
      case 2:
        GPIOPinWrite(SRC_PORT, SRC_PIN0 | SRC_PIN1 | SRC_PIN2 | SRC_PIN3, SRC_PIN2 );
        break;
      case 3:
        GPIOPinWrite(SRC_PORT, SRC_PIN0 | SRC_PIN1 | SRC_PIN2 | SRC_PIN3, SRC_PIN3 );
        break;
...
void vLEDMatrixInit(void){
    ...
    GPIOPinTypeGPIOOutput(SRC_PORT, SRC_PIN0 | SRC_PIN1 | SRC_PIN2 | SRC_PIN3 );
